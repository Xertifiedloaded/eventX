...
router.get(
  "/geocode",
  auth(),
  validate(locationValidation.geocodeAddress),
  locationController.geocodeAddress
);
router.get(
  "/reverse-geocode",
  auth(),
  validate(locationValidation.reverseGeocode),
  locationController.reverseGeocode
);
router.get(
  "/nearby",
  auth(),
  validate(locationValidation.getNearbyPlaces),
  locationController.getNearbyPlaces
);
router.post(
  "/",
  auth("manageLocations"),
...
router.get(
  "/:locationId/static-map",
  auth(),
  validate(locationValidation.getLocation),
  locationController.getStaticMapUrl
);
